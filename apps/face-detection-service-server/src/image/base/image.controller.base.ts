...
import { FaceDetectionResultFindManyArgs } from "../../faceDetectionResult/base/FaceDetectionResultFindManyArgs";
...
export class ImageControllerBase {
  ...
  @common.Get("/:id/faceDetectionResults")
  @ApiNestedQuery(FaceDetectionResultFindManyArgs)
  async findFaceDetectionResults(
    @common.Req() request: Request,
    @common.Param() params: ImageWhereUniqueInput
  ): Promise<FaceDetectionResult[]> {
    const query = plainToClass(FaceDetectionResultFindManyArgs, request.query);
    const results = await this.service.findFaceDetectionResults(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/faceDetectionResults")
  async connectFaceDetectionResults(
    @common.Param() params: ImageWhereUniqueInput,
    @common.Body() body: FaceDetectionResultWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Patch("/:id/faceDetectionResults")
  async updateFaceDetectionResults(
    @common.Param() params: ImageWhereUniqueInput,
    @common.Body() body: FaceDetectionResultWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/faceDetectionResults")
  async disconnectFaceDetectionResults(
    @common.Param() params: ImageWhereUniqueInput,
    @common.Body() body: FaceDetectionResultWhereUniqueInput[]
  ): Promise<void> {
    const data = {
